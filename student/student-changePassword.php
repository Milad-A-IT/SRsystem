...
$sql = "SELECT * FROM student WHERE euid = '$sid'";
        ...
        <nav class="navbar navbar-fixed-top">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a href="student-home.php" class="navbar-brand"> GROUP 404 | Change Password</a>
				</div>
				<div class="collapse navbar-collapse" id="navbar">
					<ul class="nav navbar-nav">
						
                        <li><?php echo "<a href=student-profile.php?euid=" . $srow["euid"] . "><span class='glyphicon glyphicon-user'></span> Profile</a>"; ?></li>
                    ...
                    <div class="col-sm-3">
                        <div class="panel">
                            ...
                            <div class="panel-body">   
                                    <li><a href="student-home.php">Home Page</a></li>
                        ...
                        <div class="well">
                            <div class="settings">
                                <h2 id="white" style="text-decoration:underline;"><?php echo $srow["first_name"]; ?>'s Password</h2>
                                    <form action="scripts/student-changePassword.php" name="newpassform" onsubmit="return CheckPasswordStudent()" method="POST">
                                    ...
                                    <a href="student-profile.php"><button type="button" class="update-button btn btn-warning fas fa-times">Cancel</button></a>
                                    </form>
                            </div>
                        </div> 
                    </div>
