...
$csql = "SELECT r.course_id AS id, c.title as coursename, c.unit as unit, c.course_lecturer as lecturer, c.location as location, c.time as classTime FROM courses c, course_registered r WHERE r.sid = '$id' AND r.course_id = c.course_id";
...
<html lang="en">
<head>
    <title>GROUP 404 | Registered courses</title>
    <meta charset="utf-8">
    ...
    ?>
        <div class="container-fluid">
          ...
          <thead>
            ...
            <a class='btn btn-primary' href='student-printCourseForm.php?id=".$id."'>Print Course Form</a>
      </div>
    </div>
    <?php
      }
...
{
    $.post("scripts/student-dropCourse_registered.php",
    {
      "id" : id
    },
		function(result){
      ...
      document.location="student-viewRegisteredCourse.php";
    }
    );
}
else
