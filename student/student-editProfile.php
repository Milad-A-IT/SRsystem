...
<body id="#home">
    <nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a href="student-home.php" class="navbar-brand"> GROUP 404 | Edit Profile</a>
            </div>
            <div class="collapse navbar-collapse" id="navbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="student-profile.php"> Welcome <b><?php echo $fname; ?></b></a></li>
    ...
    <div class="container">
        <div class="row">
            <form action="scripts/student-editProfile.php" name="update" onsubmit="return CheckPasswordStudent()" method="POST">
                <div class="col-md-6">
                <!-- Profile Image -->
                ...
                <div class="col-md-6">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <a href="student-profile.php"><button type="button" class="update-button btn btn-success fas fa-times"> Cancel</button></a>
                        </div>
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
