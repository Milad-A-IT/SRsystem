...
<html lang="en">
<head>
    <title> GROUP 404 | Admin Profile</title>
    <meta charset="utf-8">
    ...
    <nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a href="admin-home.php" class="navbar-brand"> GROUP 404 | Admin Profile</a>
            </div>
                ...
                <div class="box box-success">
                    <div class="box-body box-profile">
                        ...
                        <li class="list-group-item">
                            ...
                            <a href="admin-editProfile.php" class="btn btn-success btn-flat fas fa-edit"> Edit</a>
                            <a href="admin-changePassword.php" class="btn btn-success btn-flat fas fa-key"> Change Password</a>
                    </div>
                </div>
            </div>
    </div>
